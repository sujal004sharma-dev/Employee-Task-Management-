...
const NewTask = ({ data }) => {
    return (
        <div className=' shrink-0 h-full m-2 rounded-3xl p-4 flex flex-col justify-between  w-100 bg-blue-500'>
            ...
            <div className='flex justify-center gap-5 mt-8 font-bold '>
                <button className='bg-green-500 rounded-3xl px-2 py-2 w-50  '>Accept Task</button>
            </div>
